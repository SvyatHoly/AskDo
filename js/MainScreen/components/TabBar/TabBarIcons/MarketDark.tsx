...
export const MarketDark: React.FC = ({ isSelected }: { isSelected?: boolean }) => {
  return (
    <>
      <Svg viewBox="0 0 48 48">
        <Defs>
          <LinearGradient x1="100%" y1="4.08%" x2="0%" y2="95.92%" id="prefix__a">
            <Stop stopColor="#FFF" stopOpacity={0.702} offset="0%" />
