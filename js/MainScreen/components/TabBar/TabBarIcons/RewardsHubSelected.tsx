...
export function RewardsHubSelected() {
  return (
    <Svg width={rem(48)} height={rem(48)} viewBox="0 0 48 48" fill="none">
      ...
      />
      <Defs>
        <LinearGradient id="a" x1={24.5} x2={24.5} y1={12} y2={35} gradientUnits="userSpaceOnUse">
          <Stop stopColor="#FF5C9D" />
          <Stop offset={1} stopColor="#955EF5" />
        </LinearGradient>
        <LinearGradient id="b" x1={24.5} x2={24.5} y1={12} y2={35} gradientUnits="userSpaceOnUse">
          <Stop stopColor="#FF5C9D" />
          <Stop offset={1} stopColor="#955EF5" />
        </LinearGradient>
        <LinearGradient id="c" x1={24.5} x2={24.5} y1={12} y2={35} gradientUnits="userSpaceOnUse">
          <Stop stopColor="#FF5C9D" />
          <Stop offset={1} stopColor="#955EF5" />
        </LinearGradient>
