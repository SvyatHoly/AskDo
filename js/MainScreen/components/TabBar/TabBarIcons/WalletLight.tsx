...
import { useOfferWallRedDotFlag } from 'OfferWall/hooks/useOfferWallRedDotFlag'

import { OrangeDot } from '../OrangeDot'

export function WalletLight() {
  const shouldShowDot = useOfferWallRedDotFlag()
  return (
    <>
      ...
      <Svg viewBox="0 0 48 48">
        ...
        <G fillRule="nonzero" fill="none">
          <Path d="M22.9 12.586l.842.842L18.42 16.5h-2.264l3.915-3.914a2 2 0 012.828 0z" fill="#636F82" opacity={0.6} />
          <Path d="M29.745 14.003l1.441 2.496h-9.764l5.591-3.228a2 2 0 012.732.732z" fill="#636F82" />
          <Path
